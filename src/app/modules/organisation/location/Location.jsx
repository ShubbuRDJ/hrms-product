...
const columns = [
    ...
    { id: 'column2', label: 'Location', minWidth: 150 },
    { id: 'column3', label: 'Location Head', minWidth: 150 },
    { id: 'column3', label: 'City', minWidth: 100 },
    { id: 'column3', label: 'Country', minWidth: 100 },
...
const Location = () => {
    ...
    return (
        <>
            <Grid className='organisation-location-main-container'>
                ...
                <Grid className='organisation-location-list-main-container'>
                    ...
                    <Grid className='list-heading-export-btn-container'>
                        <Grid className='list-pagination-limit'>
                            <span>Show</span>
                            <Grid className='organisation-location-table-limit-filter'>
                                <FilterTableLimit
                    ...
                    <Grid className='organisation-location-table-container'>
                        <TableCustom
                            columns={columns}
                            datas={dummyData}
                            dataKey={dataKey}
                    ...
                    <Grid className='organisation-location-pagination-container'>
