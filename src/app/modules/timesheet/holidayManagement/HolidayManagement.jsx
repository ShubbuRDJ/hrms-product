...
import './holiday-management.scss'
...
const dummyData = [
    {
        ...
        holiday_type: 'Fixed Holiday',
        holiday_status: 'Published',
        start_date: 'Aug 15, 2022',
        end_date: 'Aug 15, 2022',
    },
    {
        event_name: 'Independence Day',
        holiday_type: 'Fixed Holiday',
...
const HolidayManagement = () => {
    ...
    const actionKey = [
        ...
        {
            actionName: 'edit',
            navigateAddress: `${routerConstants?.editHolidayRoute}`
        },
        {
            actionName: 'delete',
    ...
    return (
        <>
            <Grid className='timesheet-holiday-management-main-container'>

                <Grid className='add-new-employee-btn-container'>
                    <h4>Add New Holiday</h4>
                    <button type="button" onClick={() => navigate(`${routerConstants?.addHolidayRoute}`)}>
                ...
                <Grid className='timesheet-holiday-management-list-main-container'>
                    <Grid className='list-heading-export-btn-container'>
                        <h4>List Of All Holiday</h4>
                        <button type="button">
                    ...
                    <Grid className='list-heading-export-btn-container'>
                        <Grid className='list-pagination-limit'>
                            <span>Show</span>
                            <Grid className='timesheet-holiday-management-table-limit-filter'>
                                <FilterTableLimit
                    ...
                    <Grid className='timesheet-holiday-management-table-container'>
                        <TableCustom
                            columns={columns}
                            datas={dummyData}
                            dataKey={dataKey}
                    ...
                    <Grid className='timesheet-holiday-management-pagination-container'>
