...
import './leave-to-acknowledge.scss'
...
const actionKey = [
    {
        actionName: 'view',
        // navigateAddress: '/leave-to-ack/edit-employee'
    },
    {
        actionName: 'chat'
    },
...
const LeavesToAcknowledge = () => {
    ...
    return (
        <>
            <Grid className='leave-to-ack-main-container'>

                <Grid className='leave-to-ack-list-main-container'>

                    <Grid className='list-heading-export-btn-container' style={{border:'none'}}>
                        <h4>Leaves to Acknowledge</h4>
                    </Grid>
                    ...
                    <Grid className='list-heading-export-btn-container'>
                        <Grid className='list-pagination-limit'>
                            <span>Show</span>
                            <Grid className='leave-to-ack-table-limit-filter'>
                                <FilterTableLimit
                    ...
                    <Grid className='leave-to-ack-table-container'>
                        <TableCustom
                            columns={columns}
                            datas={dummyData}
                            dataKey={dataKey}
                    ...
                    <Grid className='leave-to-ack-pagination-container'>
...
export default LeavesToAcknowledge
