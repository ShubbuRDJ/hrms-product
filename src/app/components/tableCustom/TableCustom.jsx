...
const TableCustom = ({ columns, datas, dataKey, actionKey, align, tableContainerMaxHeight }) => {
  ...
  const [customDatas, setCustomDatas] = useState(datas)
  ...
  const handleAscClick = (id) => {
    const sortDirectionEle = document?.querySelectorAll('.table-custom-sort-direction');
    sortDirectionEle?.forEach((ele) => {
      ele.style.fill = '#B6B7BC'
    })
    const eleAsc = document.getElementById(`table-custom-asc-${id}`)
    eleAsc.style.fill = '#000000';
    const tempDatas = [...customDatas];
    tempDatas.sort((a, b) => {
      return a[id].localeCompare(b[id]);
    });
    setCustomDatas([...tempDatas])
  }
  const handleDescClick = (id) => {
    ...
    const eleAsc = document.getElementById(`table-custom-desc-${id}`)
    eleAsc.style.fill = '#000000';
    const tempDatas = [...customDatas];
    tempDatas.sort((a, b) => {
                              ...
                              actionKey?.map((action) => {
                                if (action?.actionName === 'welcome') {
                                  return (<svg style={{ cursor: 'pointer' }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="24" height="24" rx="4" fill="#5E436E" fillOpacity="0.1" />
                                  ...
                                  return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="24" height="24" rx="4" fill="#C8C000" fillOpacity="0.1" />
                                  ...
                                  return (<IconButton disableRipple disabled={(data['final_approval']?.rollback) ? true : false} >
                                    <svg onClick={() => handleDeleteAction(action)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <rect width="24" height="24" rx="4" fill="#006D84" fillOpacity="0.1" />
                                  ...
                                  return (<svg onClick={() => handleActionButton(action, data)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="24" height="24" rx="4" fill="#F4EFFF" />
                                    <path d="M12.8396 6.40006L7.36624 12.1934C7.15958 12.4134 6.95958 12.8467 6.91958 13.1467L6.67291 15.3067C6.58624 16.0867 7.14624 16.6201 7.91958 16.4867L10.0662 16.1201C10.3662 16.0667 10.7862 15.8467 10.9929 15.6201L16.4662 9.82673C17.4129 8.82673 17.8396 7.68673 16.3662 6.2934C14.8996 4.9134 13.7862 5.40006 12.8396 6.40006Z" stroke="#8C62FF" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M11.9258 7.3667C12.2124 9.2067 13.7058 10.6134 15.5591 10.8" stroke="#8C62FF" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M6 18.6667H18" stroke="#8C62FF" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                  </svg>)
                                }
                                  ...
                                  return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="24" height="24" rx="4" fill="#4880FF" fillOpacity="0.1" />
